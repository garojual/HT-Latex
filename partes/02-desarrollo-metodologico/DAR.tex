...
La aplicación de la metodología~\DAR~aportó transparencia, trazabilidad y rigor al proceso de selección, asegurando que la notación y las herramientas elegidas se fundamentaran en un análisis comparativo objetivo y alineado con las necesidades del proyecto~\NDITI~y con las metas estratégicas del~\GRID~en materia de modelado y gestión de infraestructura tecnológica.
...
Para la búsqueda realizada en google trends, se estableció un rango de tiempo desde 2020 a 2024 para conocordar con lo 
...
Los resultados del análisis se presentan en la Tabla \ref{tab:analisis_dar}, donde cada notación fue evaluada con puntuaciones del 1 al 3 según su desempeño en cada criterio.
...
Con base en los resultados obtenidos, el siguiente paso consiste en seleccionar una notación principal que sirva como base estructural para el proyecto. A partir de ella, se identificarán sus limitaciones específicas y se integrarán elementos conceptuales o sintácticos provenientes de las otras notaciones evaluadas, con el fin de fortalecer aquellos aspectos donde la notación base resulte menos robusta.
