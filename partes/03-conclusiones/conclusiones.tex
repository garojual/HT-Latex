...
\noindent
A partir de los resultados obtenidos y las limitaciones identificadas, se plantean las siguientes líneas de trabajo futuro, orientadas a consolidar y ampliar el alcance de la \NDITI.

La primera y más inmediata corresponde al refinamiento de la notación a partir de la retroalimentación obtenida en la validación. Los hallazgos del ejercicio y de la encuesta de percepción señalan áreas concretas de mejora: la diferenciación visual entre capas, el tamaño y la intuitividad de los íconos representativos de cada elemento, y la especificidad semántica de algunos componentes que generaron ambigüedad durante el modelado. Una segunda iteración de diseño que incorpore estas observaciones fortalecería la usabilidad de la notación y reduciría la curva de aprendizaje inicial, que fue el aspecto de menor valoración en la encuesta.

Una segunda línea de trabajo consiste en el desarrollo de soporte en herramientas de software especializadas. La implementación de la \NDITI en un entorno de diagramación que incluya nativamente sus elementos, relaciones y restricciones semánticas permitiría reducir la carga cognitiva asociada a su uso, facilitar la reutilización de modelos y habilitar su adopción a mayor escala. Esta línea podría explorarse mediante la extensión de herramientas existentes de código abierto o el desarrollo de un plugin para plataformas ampliamente utilizadas en contextos académicos.

En tercer lugar, se identifica la necesidad de ampliar la validación a muestras más grandes y contextos más diversos. Esto incluye su evaluación con docentes que la utilicen como herramienta de enseñanza, su aplicación en otros programas académicos con perfiles de usuario distintos, y su uso en escenarios de mayor complejidad que los abordados en el ejercicio inicial. Una validación más amplia permitiría establecer afirmaciones más robustas sobre la generalización de los resultados obtenidos.

Finalmente, una línea de trabajo de mayor alcance consiste en explorar la integración de la \NDITI en los procesos formales del programa de Ingeniería de Sistemas y Computación y del grupo \GRID. Esto podría materializarse en su incorporación como herramienta de referencia en asignaturas relacionadas con infraestructura y arquitectura de TI, o en su adopción como estándar interno para la documentación de proyectos dentro del grupo de investigación, consolidando así su impacto institucional más allá del contexto experimental en que fue evaluada.
