...
\begin{table}[H]
\centering
\caption{Respuestas abiertas -- Pregunta 1: ¿Qué fue lo más fácil de entender de la notación?}
...
\begin{table}[H]
\centering
\caption{Respuestas abiertas -- Pregunta 2: ¿Qué elementos o aspectos de la notación mejoraría?}
...
\begin{table}[H]
\centering
\caption{Respuestas abiertas -- Pregunta 3: ¿Hubo algún momento en el que no supo qué elemento o relación utilizar? Explique.}
