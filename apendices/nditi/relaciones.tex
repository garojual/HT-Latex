\section{Relaciones del lenguaje NDITI}
\label{sec:relaciones_ndti}

\noindent
Las relaciones definidas en el lenguaje NDITI permiten establecer vínculos semánticos entre los distintos elementos del modelo. Estas se clasifican en relaciones de tipo estructural y conductual, dependiendo de si representan dependencias estáticas o interacciones dinámicas dentro del sistema.
...
>{\raggedright\arraybackslash}m{4cm}|}
\caption{Relaciones del lenguaje NDITI} \label{tab:relaciones_ndti_formal} \\
...
\noindent
Las relaciones del lenguaje NDITI se clasifican en:
